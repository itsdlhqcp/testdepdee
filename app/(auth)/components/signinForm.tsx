...
// import { useEffect, useState } from "react";
// import { loginUser } from "@/serverActions/auth";
// import { setCookie, setUserCookies } from "@/serverActions/cookies";
...
//         // if(response.data?.data?.user?.phone_number_verified) {
//         //   const phoneVerified = response.data?.data?.user?.phone_number_verified;
...
import { useEffect, useState } from "react";
import { loginUser } from "@/serverActions/auth";
import { setAuthCookies } from "@/serverActions/cookies";
import { Eye, EyeOff } from "lucide-react";
